...
export default function RosetteLanding({ position, onComplete }: RosetteLandingProps) {
  return (
    ...
    >
      <motion.div
        className="absolute -translate-x-1/2 -translate-y-11 whitespace-nowrap rounded-full border border-brass/60 bg-ink-soft px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-brass-light"
      ...
      <motion.div
        className="absolute -translate-x-1/2 -translate-y-1/2 text-brass"
